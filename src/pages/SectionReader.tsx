  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-secondary/5">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <Button variant="ghost" onClick={() => navigate("/sections")} className="mb-4 btn-press">
          <ArrowLeft className="mr-2 h-4 w-4" />
          Back to Sections
        </Button>

        <Card className="mb-6 animate-fade-in card-hover">
          <CardHeader>
            <div className="flex items-center gap-2 mb-2">
              <Badge variant="outline" className="animate-scale-in">{section.spec_tag}</Badge>
              <Badge variant={section.level === "Higher" ? "default" : "secondary"} className="animate-scale-in">
                {section.level}
              </Badge>
            </div>
        ...
        <Card className="mt-6 bg-gradient-to-br from-primary/10 to-secondary/10 border-primary/20 animate-fade-in hover-lift">
          <CardHeader>
          ...
          <CardContent>
            <Button
              size="lg"
              className="w-full bg-gradient-to-r from-primary to-secondary hover:opacity-90 transition-opacity btn-press"
